...
import { Megaphone, SendHorizonal, Pin, CheckCircle2 } from "lucide-react";
      ...
      >
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            ...
            <p className="text-sm text-surface-200/40">Broadcast to the community</p>
          </div>
        </div>
      </motion.header>
      ...
      >
        ...
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 rounded-xl bg-surface-900/50 border border-surface-200/10 text-white text-sm placeholder:text-surface-200/25 focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/30 transition-all"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={5}
            className="w-full px-4 py-3 rounded-xl bg-surface-900/50 border border-surface-200/10 text-white text-sm placeholder:text-surface-200/25 focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/30 transition-all resize-none"
          />
        </div>
          ...
          <div>
            ...
            {scopeType === "year" && (
              <select
                ...
                className="w-full px-4 py-3 rounded-xl bg-surface-900/50 border border-surface-200/10 text-white text-sm focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/30 transition-all cursor-pointer appearance-none"
              >
            ...
            {scopeType === "global" && (
              <p className="text-[11px] text-surface-200/35 italic">All students will see this announcement.</p>
            )}
            {scopeType === "year" && targetYear > 0 && (
              <p className="text-[11px] text-surface-200/35 mt-1.5 italic">
              ...
              className={`
                ...
                ${
                  pinned
                    ...
                    : "bg-surface-900/50 border-surface-200/10 text-surface-200/40 hover:border-amber-500/20 hover:text-amber-400/60"
                }
              `}
            >
              <Pin size={14} className={pinned ? "fill-amber-400" : ""} />
              Pin
            </button>
          </div>
        </div>
